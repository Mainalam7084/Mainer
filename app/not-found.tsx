...
export default function NotFound() {
  return (
    <main className="mx-auto grid min-h-screen max-w-xl place-content-center px-4 text-center">
      <div className="rounded-vault border-2 border-vault-border bg-vault-card p-8 shadow-vault">
        ...
        <Link
          href="/collection"
          className="mt-5 inline-flex rounded-full border-2 border-vault-border bg-vault-accent px-4 py-2 font-bold text-vault-bg"
        >
